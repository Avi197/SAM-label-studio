...
def load_my_model(device="cuda:0", sam_config="vit_h", sam_checkpoint_file="sam_vit_h_4b8939.pth"):
    """
...
class MMDetection(LabelStudioMLBase):
    ...
    def __init__(self,
        ...
        if 'RectangleLabels' in self.parsed_label_config and self.out_bbox:
            ...
            self.from_name_RectangleLabels, self.to_name_RectangleLabels, self.value_RectangleLabels, self.labels_in_config_RectangleLabels = get_single_tag_keys(
                # noqa E501
        ...
        if 'BrushLabels' in self.parsed_label_config:
            ...
            self.from_name_BrushLabels, self.to_name_BrushLabels, self.value_BrushLabels, self.labels_in_config_BrushLabels = get_single_tag_keys(
                # noqa E501
                self.parsed_label_config_BrushLabels, 'BrushLabels', 'Image')
        ...
        if 'PolygonLabels' in self.parsed_label_config and self.out_poly:
            ...
            self.from_name_PolygonLabels, self.to_name_PolygonLabels, self.value_PolygonLabels, self.labels_in_config_PolygonLabels = get_single_tag_keys(
                # noqa E501
                self.parsed_label_config_PolygonLabels, 'PolygonLabels', 'Image')
    ...
    def predict(self, tasks, **kwargs):
        ...
        # config for keypoint, if you want to use more than 1 keypoint like in sam, code here
        ...
        # remove predictor after use so the ram didn't accumulate
        del predictor
